...
export function initialSchedule(nowMs) {
    return {
        pimsleurLevel: 0,
...
export function scheduleAfterCorrect(currentLevel, nowMs) {
...
export function scheduleAfterWrong(nowMs) {
