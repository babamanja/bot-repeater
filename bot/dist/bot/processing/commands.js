import { handleAddWordFlowText, handleAddWordPickCallback, startAddWordDialog, } from '../word/add-word-flow-handlers';
import { handleReviewCancelCallback, handleReviewDontCallback, handleReviewKnowCallback, handleReviewMoreCallback, runVocabReview, } from '../word/review-handlers';
import { handleSettingsMenuCallback, handleSettingsReply } from './settings-handler';
import { ADD_WORDS_BUTTON_LABELS, REPEAT_WORDS_BUTTON_LABELS, SETTINGS_BUTTON_LABELS, } from '../../i18n';
export function registerProcessingCommands(bot, pool) {
    ...
    bot.action(/^settings_(change_primary|change_learning|back)$/, (ctx) => handleSettingsMenuCallback(ctx, pool));
