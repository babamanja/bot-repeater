...
export function clampGuestSourceText(text, isGuest) {
    if (!isGuest) {
        return text;
    }
...
export async function resolveGuestQuestionCount(userId, requestedCount) {
...
export async function mergeGuestIntoUser(guestUserId, targetUserId) {
