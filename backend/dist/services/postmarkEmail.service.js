...
export function getAuthPublicAppUrl() {
...
export function normalizeOptionalAppOrigin(raw) {
...
export function resolveAuthEmailAppBase(clientAppBaseUrl) {
...
function getFeedbackInboxEmail() {
