...
router.post("/users/:userId/subscription/grant-premium", asyncHandler(adminController.grantPremiumSubscription));
...
router.get("/chunk-summary-prompt-template", asyncHandler(adminController.getChunkSummaryPromptTemplate));
router.put("/chunk-summary-prompt-template", asyncHandler(adminController.updateChunkSummaryPromptTemplate));
router.post("/chunk-summary-prompt-template/reset", asyncHandler(adminController.resetChunkSummaryPromptTemplate));
...
router.post("/generation-settings/reset", asyncHandler(adminController.resetGenerationSettings));
...
router.put("/qualification-template", asyncHandler(adminController.updateQualificationTemplate));
router.get("/qualification-submissions", asyncHandler(adminController.listQualificationSubmissions));
