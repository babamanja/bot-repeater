...
const TEMPLATE_FILE_PATH = resolve(process.cwd(), "data", "ai-chunk-summary-prompt-template.txt");
...
export function getChunkSummaryPromptTemplate() {
    return currentTemplate;
}
export function getDefaultChunkSummaryPromptTemplate() {
    return DEFAULT_PROMPT_TEMPLATE;
}
export function updateChunkSummaryPromptTemplate(template) {
...
export function resetChunkSummaryPromptTemplate() {
