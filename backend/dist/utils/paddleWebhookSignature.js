...
export function isPaddleTimestampFresh(timestamp) {
...
export function getPaddleWebhookVerificationFailure(rawBody, signatureHeader, secret) {
...
export function verifyPaddleWebhookSignature(rawBody, signatureHeader, secret) {
    return (getPaddleWebhookVerificationFailure(rawBody, signatureHeader, secret) ===
        null);
}
