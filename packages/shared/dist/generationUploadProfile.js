...
import { UPLOAD_MAX_BYTES_BASIC, UPLOAD_MAX_BYTES_PREMIUM, UPLOAD_MAX_TEXT_CHARS_BASIC, UPLOAD_MAX_TEXT_CHARS_PREMIUM, } from "./uploadLimits.js";
...
export const LANDING_UPLOAD_PROFILE = {
    key: "landing",
...
export function buildAppUploadProfileForPlan(isPremium) {
    if (!isPremium) {
        return {
            key: "app",
            maxBytes: UPLOAD_MAX_BYTES_BASIC,
...
export function parseUploadProfileKey(value) {
...
export function applyPdfPagePolicy(pages, totalPages, profile) {
...
export function buildPagePreview(text, maxChars = 280) {
