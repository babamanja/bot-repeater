...
export const TOKEN_PACK_PRICES_USD = {
    10: 0.99,
    25: 1.99,
    50: 3.49,
    100: 5.99,
...
export function isTokenTopupAmount(value) {
    return TOKEN_TOPUP_AMOUNTS.includes(value);
}
export function getTokenTopupAmountUsd(tokenAmount, applyPremiumDiscount = false) {
